...
class TurbineTile(Tile):
    ...
    * lemon - počet LEMONov v turbíne
    ...
    def __repr__(self):
        return f"TurbineTile({self.lemon})"
...
class TreeTile(Tile):
    ...
    * has_lemon - má tento strom LEMON?
    ...
    def __repr__(self):
        return f"TreeTile({self.has_lemon})"
...
class World:
    ...
    * oxygen - pole [y][x] intov s hodnotami kyslíka
    ...
    def __repr__(self):
        return f"World({self.width}, {self.height}, {self.tiles}, {self.oxygen})"
...
class Turn:
    ...
    def __repr__(self):
        return f"Turn({self.command}, {self.args})"
...
class Player:
    ...
    * alive - má hráč aspoň jedného živého lemura?
    ...
    def __repr__(self):
        return f"Player({self.idx}, {self.lemurs})"
...
class ProbojPlayer:
    ...
    * myself - môj hráč v poli players
    ...
    def log(self, *args):
        ...
        """
        print(f"[{self.logid}]", *args, file=sys.stderr)
    ...
    def __repr__(self):
        return f"ProbojPlayer({self.world}, {self.players}, {self.myself})"